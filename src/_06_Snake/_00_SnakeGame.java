...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "you should know how to play snake";
	...
	private void setFoodLocation() {
		...
		Location nLocation = new Location(randy.nextInt(WIDTH), randy.nextInt(HEIGHT));
		...
		if(snake.isLocationOnSnake(nLocation)) {
			setFoodLocation();
		}else {
			foodLocation=nLocation;
		}
	}
